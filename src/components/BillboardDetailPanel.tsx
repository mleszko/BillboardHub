...
export function BillboardDetailPanel({ billboard, open, onOpenChange, variant = "sheet" }: Props) {
        ...
        <div className="flex items-center justify-between gap-3 rounded-lg border bg-card p-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-[11px] text-muted-foreground">Cena vs. zasięg w regionie</div>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <BetaBadge />
        ...
        <div className="overflow-hidden rounded-lg border bg-card">
          ...
          >
            <div>
              ...
              <p className="mt-1 text-xs font-medium text-muted-foreground">Podgląd 360° wkrótce</p>
              <p className="text-[10px] text-muted-foreground/70">Integracja Google Street View</p>
            </div>
          </div>
        </div>
