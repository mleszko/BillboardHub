...
class Contract(Base):
    ...
    total_contract_value_net: Mapped[Decimal | None] = mapped_column(Numeric(14, 2), nullable=True)
    ...
    surface_size: Mapped[str | None] = mapped_column(String(120), nullable=True)
